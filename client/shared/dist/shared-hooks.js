import { importShared } from './__federation_fn_import-26b4dac1.js';
export { usePreloader } from './__federation_expose_Preloader-a56bdab3.js';

const {useEffect: useEffect$1,useCallback,useState: useState$1} = await importShared('react');
...
function SocialNets() {
  const socialLinks = [
    ...
    {
      icon: /* @__PURE__ */ React.createElement(FaYoutube, null),
    ...
    {
      icon: /* @__PURE__ */ React.createElement(FaRegEnvelope, null),
      url: "mailto:contact@example.com",
      ariaLabel: "Email us",
      class: "fa fa-envelope-o"
    }
  ];
  return /* @__PURE__ */ React.createElement(React.Fragment, null, socialLinks.map((link, index) => /* @__PURE__ */ React.createElement(
    "a",
    {
      key: index,
      href: link.url,
...
export { SocialNets, useHamburgerMenu, useSetBgImages, useTabs };
